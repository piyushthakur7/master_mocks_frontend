    ...
    <section className="py-24 bg-gradient-to-tr from-brand/5 via-white to-orange-500/5 relative overflow-hidden border-y border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-8 text-center">
            Hi Learners,
          </h2>
          <div className="space-y-6 text-xl sm:text-2xl text-slate-600 leading-relaxed text-center md:text-left">
            <p>
            ...
            <div className="pt-10">
              <h3 className="text-3xl font-bold text-slate-900 mb-6 text-center">How are we DIFFERENT?</h3>
              <p>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-8 mt-10 shadow-xl shadow-slate-200/50">
              <h4 className="font-bold text-slate-900 mb-4 text-center text-2xl">For reference:</h4>
              <p className="text-center mb-10 font-medium text-slate-500 text-lg">If 100 students gave a particular PAID mock, then:</p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div className="bg-green-50 text-green-700 p-6 rounded-2xl border border-green-100 shadow-inner">
                  <div className="text-sm font-bold uppercase tracking-wider mb-2 text-green-600/80">Top 5 Students</div>
                  <div className="font-black text-4xl mb-1 flex items-baseline justify-center gap-1">
                    <span>₹25</span>
                    <span className="text-lg font-bold text-green-600/60">each</span>
                  </div>
                </div>
                <div className="bg-blue-50 text-blue-700 p-6 rounded-2xl border border-blue-100 shadow-inner">
                  <div className="text-sm font-bold uppercase tracking-wider mb-2 text-blue-600/80">Next 5 Students</div>
                  <div className="font-black text-4xl mb-1 flex items-baseline justify-center gap-1">
                    <span>₹20</span>
                    <span className="text-lg font-bold text-blue-600/60">each</span>
                  </div>
                </div>
                <div className="bg-orange-50 text-orange-700 p-6 rounded-2xl border border-orange-100 shadow-inner">
                  <div className="text-sm font-bold uppercase tracking-wider mb-2 text-orange-600/80">Next 5 Students</div>
                  <div className="font-black text-4xl mb-1 flex items-baseline justify-center gap-1">
                    <span>₹15</span>
                    <span className="text-lg font-bold text-orange-600/60">each</span>
                  </div>
                </div>
              </div>
            </div>
